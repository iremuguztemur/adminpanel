					...
					current_image.onload = function () {
						...
						if (orientation > 4) {
							...
							draw2({
								...
								x1 : 0,
								y1 : 0,
								x2 : current_image.naturalWidth,
								y2 : current_image.naturalHeight,
								cx : 0,
								cy : 0,
								width : current_image.naturalWidth,
								height : current_image.naturalHeight,
								canvasWidth : current_image.naturalHeight,
								canvasHeight : current_image.naturalWidth,
							},
							function(data) {
								console.log(data);
							});	
