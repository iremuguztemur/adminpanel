    ...
    <section class="page-content-inner">
        <section class="panel panel-with-borders col-md-9">
            <div class="panel-heading">
                <h3>Ürün Düzenle / <small>[ <?=$edit['product_name']?> ]</small></h3>
            </div>
            ...
            <div class="panel-body">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                          <textarea name="product_description" class="form-control" rows="8" cols="80" placeholder="Açıklama"><?=$edit['product_description']?></textarea>
                        </div>
                        <div class="form-group">
                          <textarea name="product_text" class="summernote" rows="8" cols="80" placeholder="Açıklama"><?=$edit['product_text']?></textarea>
                        </div>
                        <div class="form-group col-md-1">
                          <div class="row">
                            <div class="btn-group" style="width : 100%;" data-toggle="buttons">
                                <label class="btn btn-default-outline link" id="product_link" style="border-radius: 0;">
                        ...
                        <div class="form-group col-md-11">
                            <input type="text" style="min-height : 40px; box-shadow : none;" name="link_url" class="form-control input-link" disabled value="<?=$edit['product_link_url']?>" placeholder="LINK URL">
                        </div>
                        <div class="form-group col-md-1">
                          <div class="row">
                        ...
                        <div class="form-group col-md-11">
                            <input type="text" style="min-height : 40px; box-shadow : none;" name="video_url" class="form-control disabled" disabled value="<?=$edit['product_video_url']?>" placeholder="VIDEO URL">
                        </div>
                      </div>
	                </form>
            </div>
...
$(document).ready(function () {
    ...
    <?php if($edit['product_video'] == 1){ ?>
      $("#video_link").trigger("click");
    <?php }; ?>

    <?php if($edit['product_link'] == 1){ ?>
