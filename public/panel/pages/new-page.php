        ...
        <section class="panel panel-with-borders col-md-9">
            ...
            <div class="panel-body">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                          <input type="text" name="page_name" class="form-control" value="" placeholder="Sayfa Adı">
                        </div>
                        <div class="form-group">
                          <textarea name="page_description" class="form-control" rows="8" cols="80" placeholder="Açıklama"></textarea>
                        </div>
                        <div class="form-group">
                          <textarea name="page_text" class="summernote" rows="8" cols="80" placeholder="İçerik"></textarea>
                        </div>
