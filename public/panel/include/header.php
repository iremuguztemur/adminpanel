...
<head>
	...
	<link rel="stylesheet" href="<?=panel_asset_url('bootstrap/css/bootstrap.min.css')?>">
	<link rel="stylesheet" href="<?=panel_asset_url('jscrollpane/style/jquery.jscrollpane.css')?>">
...
<body class="theme-default menu-static" >
