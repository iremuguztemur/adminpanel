...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 01 May 2017, 19:14:39
...
--
-- Tablo döküm verisi `img_library`
--

INSERT INTO `img_library` (`img_id`, `gallery_id`, `image_name`, `url`, `add_date`) VALUES
(2, 2, '8d1aff5be72f8d7243f7db163005d66b1eaf9a71.jpg', '', '');
...
CREATE TABLE `products` (
  ...
  `product_categori_id` int(11) NOT NULL,
  `product_subcategori_id` int(11) NOT NULL,
  `image` varchar(255) NOT NULL,
  `product_code` varchar(255) NOT NULL,
  `dmo_code` varchar(255) NOT NULL,
  `product_price` varchar(255) NOT NULL,
  `dmo_price` varchar(255) NOT NULL,
  `product_name` varchar(255) NOT NULL,
  `baslik_self` varchar(255) NOT NULL,
  `product_description` text NOT NULL,
  `product_text` longtext NOT NULL,
  `item_title` varchar(255) NOT NULL,
  `item_width` varchar(255) NOT NULL,
  `item_height` varchar(255) NOT NULL,
  `item_size` varchar(255) NOT NULL,
  `second_item_title` varchar(255) NOT NULL,
  `second_item_width` varchar(255) NOT NULL,
  `second_item_height` varchar(255) NOT NULL,
  `second_item_size` varchar(255) NOT NULL,
...
INSERT INTO `products` (`product_id`, `product_group_id`, `product_categori_id`, `product_subcategori_id`, `image`, `product_code`, `dmo_code`, `product_price`, `dmo_price`, `product_name`, `baslik_self`, `product_description`, `product_text`, `item_title`, `item_width`, `item_height`, `item_size`, `second_item_title`, `second_item_width`, `second_item_height`, `second_item_size`, `tags`, `stats`, `add_date`, `number`) VALUES
(2, 2, 8, 6, '', 'F.02.05.01.01.001', '335703001', '0', '0', 'Tek Kişilik İlkokul Tip', 'tek-kisilik-ilkokul-tip', '', '', 'Masa', '60', '40', '61', 'Oturak', '60', '36', '35', '["S\\u0131ra","\\u0130lkokul","Okul","S\\u0131ras\\u0131","Masif","Ah\\u015fap"]', 1, '', 0);
...
(1, 1, 'ALFA', 'alfa', '', '', 1, 0),
(2, 1, 'STYLE', 'style', '', '', 1, 0),
(5, 2, 'Optimus', 'optimus', '', '', 1, 0),
(6, 8, 'Masif', 'masif', '', '', 1, 0),
(7, 8, 'Werzalit', 'werzalit', '', '', 1, 0),
(8, 8, 'Compact', 'compact', '', '', 1, 0);
...
--
ALTER TABLE `product_categori`
  MODIFY `categori_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `product_subcategori`
  MODIFY `subcategori_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
