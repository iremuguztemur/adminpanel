...
# post methodu ile gelen veriler almak için
function post($name){
  if(isset($_POST[$name])){
...
# get sitenin urlini almak için
function site_url($url = null){
  return surl . '/' . $url;
}
# css, javascrip, resim veya assest klasöründe bulunan kütüphanelere erişmek için ..
function asset_url($url = null){
  return surl . 'assets/' . $url;
}
# get sitenin urlini almak için
function panel_url($url = null){
  return surl . '/panel/' . $url;
}
# css, javascrip, resim veya assest klasöründe bulunan kütüphanelere erişmek için ..
function admin_asset_url($url = null){
  return surl . 'assets/panel/' . $url;
}

# code by : Tayfun ERBİLEN
# seo link function.
